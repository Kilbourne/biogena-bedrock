 ...
 <% if(first.title !=='Specialità Medicinali'){ %>
            ...
            <div class="content-wrapper">
                ...
                <div class="products">
                  ...
                  <% _.each(first.prodotti,function(prod,key){ %>
                                <div class="product flag-media <%= key % 2 == 0?'odd':'even' %>"><a href="<%= prod.permalink %>"><div><h3 class='product-title' ><%= prod.title %> </h3> </div> </a><div class="flag-thumb"><a href="<%= prod.permalink %>"> <%= prod.thumbnail %></a> </div><div class="flag-body"><%= prod.content %><div class="more"><a href="<%= prod['permalink'] %>" title="">Vai alla scheda prodotto</a> </div></div> </div>
                  <% } )%>
                  </div>
              </div>
